...
const terrainGroup = Object.freeze({
  ...
  children: Object.freeze([
    ...
    Object.freeze({
      ...
      description:
        "Strength multiplier for ridge contributions on top of base terrain.",
      type: numberType,
      min: 0,
      max: 64,
      step: 0.1,
    ...
    Object.freeze({
      id: "terrain.fm",
      label: "FM Attenuation",
      description:
        "Six-operator frequency-modulated attenuation network used to sculpt macro terrain height.",
      type: groupType,
      children: Object.freeze([
        Object.freeze({
          id: "terrain.fm.base",
          ...
          description:
            "Baseline multiplier applied before FM operators add additional modulation.",
          type: numberType,
          min: 0,
          max: 4,
          step: 0.01,
          default: 0.95,
          path: Object.freeze(["terrain", "fm", "base"]),
        }),
        Object.freeze({
          id: "terrain.fm.min",
          label: "Minimum Attenuation",
          description: "Lower clamp for the FM attenuation multiplier.",
          type: numberType,
          min: 0,
          max: 4,
          step: 0.01,
          default: 0.45,
          path: Object.freeze(["terrain", "fm", "min"]),
        }),
        Object.freeze({
          id: "terrain.fm.max",
          label: "Maximum Attenuation",
          description: "Upper clamp for the FM attenuation multiplier.",
          type: numberType,
          min: 0,
          max: 4,
          step: 0.01,
          default: 1.75,
          path: Object.freeze(["terrain", "fm", "max"]),
        }),
        Object.freeze({
          id: "terrain.fm.slopeWeight",
          label: "Slope Weight",
          description:
            "Influence of local slope on the FM attenuation envelope.",
          type: numberType,
          min: -4,
          max: 4,
          step: 0.01,
          default: -0.35,
          path: Object.freeze(["terrain", "fm", "slopeWeight"]),
        }),
        Object.freeze({
          id: "terrain.fm.altitudeWeight",
          label: "Altitude Weight",
          description:
            "Influence of normalized altitude on the FM attenuation envelope.",
          type: numberType,
          min: -4,
          max: 4,
          step: 0.01,
          default: -0.25,
          path: Object.freeze(["terrain", "fm", "altitudeWeight"]),
        }),
        Object.freeze({
          id: "terrain.fm.biomeBlendStrength",
          label: "Biome Blend Strength",
          description:
            "Blend factor controlling how strongly biome profiles steer operator weighting.",
          type: numberType,
          min: 0,
          max: 1,
          step: 0.01,
          default: 0.7,
          path: Object.freeze(["terrain", "fm", "biomeBlendStrength"]),
        }),
      ]),
    }),
  ]),
