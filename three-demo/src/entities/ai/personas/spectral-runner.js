export const spectralRunnerPersona = {
  ...
  metadata: {
    movement: {
      ...
      headingTurnSpeed: 6,
      observeDurationRange: [3, 5.5],
      postObserveWalkChance: 0.6,
      postObserveWalkDurationRange: [6, 10],
      lingerDurationRange: [2.5, 4.5],
      lingerResumeWalkChance: 0.65,
    },
    presentation: {
      states: {
        ...
        observe: { animation: { variant: 'idle', fadeDuration: 0.25 } },
